...
/*   Updated: 2025/05/07 17:26:09 by tlutz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv, char **envp)
{
	...
	second_cmd->outfile = NULL;
	second_cmd->append = FALSE;
	second_cmd->pipe = TRUE;
	second_cmd->heredoc = NULL;
	second_cmd->args = malloc(sizeof(char *) * 2);
	second_cmd->args[0] = ft_strdup("/usr/bin/rev");
	second_cmd->args[1] = NULL;
