...
/*   Updated: 2025/05/08 13:28:00 by tmarion          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_cmd *ft_create_node(t_cmd *cmd_list, t_token *lexicon)// t_token *lexicon
{
	t_cmd *new_node;
	t_cmd *curent_node;
...
static t_cmd *create_exec_list(t_cmd *cmd_list)
{
...
int exec(t_token *lexicon, t_mshell *mshell)
{
	...
	cmd_list = NULL;
	create_exec_list(cmd_list);
	while (is_pipe()) //envoyer tout jusqu'au pipe pour initialiser les tructures et organiser ça avec l'index du lexicon pour reperer les pipes
	{
